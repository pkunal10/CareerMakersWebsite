<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserWithOutSlider.master" AutoEventWireup="true" CodeFile="Jobs.aspx.cs" Inherits="User_Admissions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="undermenuarea">
        ...
        <div class="grid">
            <div class="row">
                <div class="c8">
                    <h1 class="titlehead">Jobs /
                        <asp:Label ID="JobCatLbl" runat="server" Text=""></asp:Label></h1>
                </div>
                <div class="c4">
