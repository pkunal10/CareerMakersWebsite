...
public partial class Admin_AdmissionCategory : System.Web.UI.Page
{
    ...
    protected void AddUpdate_Click(object sender, EventArgs e)
    {
        if (ActionLbl.Text == "Add")
        {
            ...
            if (NameTb.Text != "")
            {
                string zk = "insert into admissioncategory (Category,IsShow) values('" + NameTb.Text + "'," + IsShowChk.Checked + ")";
                dc.setdata(zk);
                ClearFields();
            }
            else
        ...
        else
        {
            if (NameTb.Text!="")
            {
                string zk = "update admissioncategory set Category='" + NameTb.Text + "',IsShow=" + IsShowChk.Checked + " where id='" + CatIdLbl.Text + "'";
                dc.setdata(zk);
                ClearFields();
            }
            else
    ...
    protected void DeleteCategory_Click(object sender, CommandEventArgs e)
    {
        ...
        string jkp = "delete from admissioncategory where id='" + id + "'";
        dc.setdata(jkp);
        ClearFields();
    }
    ...
    {
        string jk = "select * from admissioncategory";
