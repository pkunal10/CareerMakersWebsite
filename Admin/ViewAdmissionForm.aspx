<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ViewAdmissionForm.aspx.cs" Inherits="Admin_Inqury" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Admission Inquiry
       
                <%--<small>Control panel</small>--%>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                <li class="active">Admission Inquiry</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Admission Category</label>
                            ...
                            <asp:Repeater ID="InquiryRptr" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="width: 100px; word-break: break-all;"><%#Eval("RegistarionDate") %></td>
                                        <td><%#Eval("Category") %></td>
                                        <td><%#Eval("FName") %> <%#Eval("MName") %> <%#Eval("LName") %></td>
                                        <td><%#Eval("EmailId") %></td>
                                        <td><%#Eval("StudenMobile") %></td>
                                        <td><%#Eval("State") %></td>                                        
                                        <td><%#Eval("Gender") %></td>                                        
                                        <td>
                                            ...
                                            <asp:LinkButton ID="ViewLb" OnCommand="ViewLb_Command" CommandArgument='<%#Eval("id") %>' CssClass="btn-sm btn-success" runat="server"><i class="fa fa-eye"></i></asp:LinkButton>
