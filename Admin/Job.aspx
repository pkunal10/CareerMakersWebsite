<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="Job.aspx.cs" Inherits="Admin_Admissions" %>
                                ...
                                <asp:Repeater ID="AdmissionRptr" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("IsShow") %></td>
                                            <td>
                                                <asp:LinkButton ID="EditJobLb" OnCommand="EditJobLb_Command" CommandArgument='<%#Eval("id") %>' CssClass="btn-sm btn-success" runat="server"><i class="fa fa-pencil"></i></asp:LinkButton>
                                                <asp:LinkButton ID="DeleteJobLb" OnCommand="DeleteJobLb_Command" CommandArgument='<%#Eval("id") %>' CssClass="btn-sm btn-danger" runat="server"><i class="fa fa-trash"></i></asp:LinkButton>
